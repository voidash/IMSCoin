    ...
    return (
        <div className=" max-w-4xl bg-gray-100  mx-auto mt-4 p-4">
            ...
            <div className="flex flex-col text-center w-1/3 mx-auto space-y-4">
                <button onClick={() => props.tab('Redeem')} className="px-2 py-1 text-blue-50 bg-blue-800 ring ring-blue-500">Redeem Coins</button>
                <button onClick={() => props.tab('BoughtItems')} className="px-2 py-1 text-blue-50 bg-blue-800 ring ring-blue-500">View Bought Items</button>
            </div>
        </div>
    );
}
